...
import { canUnlockModule, unlockModule, evaluateModuleCompletion, initializeModuleProgression } from '../service.js';
...
vi.mock('@core/module/progression.js', () => ({
  isModuleFullyCompleted: vi.fn(),
}));

vi.mock('../requirements.js', async () => {
  const actual = await vi.importActual('../requirements.js');
  return {
    ...actual,
...
describe('Unlock Service', () => {
  ...
  describe('canUnlockModule', () => {
    ...
    it('should check other unlock requirements', async () => {
      const { checkUnlockRequirement, requiresUserInteraction } = await import('../requirements.js');
  ...
  describe('evaluateModuleCompletion', () => {
    ...
    it('should mark module as completed and unlock dependents', async () => {
      ...
      const { checkUnlockRequirement } = await import('../requirements.js');
      vi.mocked(checkUnlockRequirement).mockResolvedValue(true);
