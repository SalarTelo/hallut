/**
 * Root Dialogue Service
 * Auto-generates root dialogue for NPCs
 */

import { dialogueNode } from '@utils/builders/dialogues.js';
import { getActiveTasks } from './taskAvailability.js';
import { evaluateCondition } from './dialogueExecution.js';
import type { NPC } from '../types/interactable.js';
import type { ModuleData } from '../types/module.js';
import type { ModuleContext } from '../types/module.js';
import type { DialogueNode, DialogueTree, DialogueEdge } from '../types/dialogue.js';
