...
import {
  ...
  executeActions,
  getAvailableChoices,
} from '../dialogueExecution.js';
import { dialogueNode, dialogueTree, taskActive, taskComplete, acceptTask, setState, setInteractableState } from '@utils/builders/dialogues.js';
...
import type { DialogueNode, DialogueTree, DialogueCondition } from '@core/types/dialogue.js';
