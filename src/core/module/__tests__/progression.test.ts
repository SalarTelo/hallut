...
describe('Module Service', () => {
  ...
  describe('checkModuleDependencies', () => {
    ...
    it('should return true if all dependencies are completed', async () => {
      ...
      // Mock checkUnlockRequirement to return true (all dependencies met)
    ...
    it('should return false if any dependency is not completed', async () => {
      ...
      // Mock checkUnlockRequirement to return false (dependencies not met)
      const { checkUnlockRequirement } = await import('@core/unlock/requirements.js');
      vi.mocked(checkUnlockRequirement).mockResolvedValue(false);
