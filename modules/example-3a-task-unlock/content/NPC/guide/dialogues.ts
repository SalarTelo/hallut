 ...
 * 
 * Complete dialogue tree explaining this module was unlocked via task completion.
 */
...
const firstGreeting = dialogueNode({
  lines: [
    ...
    'This module was unlocked by completing a task.',
    'It was in the Progression Example.',
...
const taskComplete = dialogueNode({
  lines: [
    ...
    'This shows how modules can be unlocked.',
    'They unlock through task completion.',
  ],
  choices: {
    thanks: {
      text: 'Thank you!',
