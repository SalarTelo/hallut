...
const firstGreeting = createDialogueNode({
  lines: [
    ...
    '• Basics - Module structure and fundamentals',
    '• Dialogues - Conversation systems',
    '• Tasks - All task types and validators',
    '• Objects - All object types and interactions',
    '• Progression - Unlocking and chains',
    '• Advanced - Password locks, handlers, custom components',
    '',
